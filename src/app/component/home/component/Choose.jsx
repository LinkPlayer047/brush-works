...
const Choose = () => {
  return (
    <>
      <div className="relative bg-[#00205b]">
        <div className="relative h-24 sm:h-32 md:h-40 lg:h-52 -mt-9 overflow-hidden">
          <svg
      ...
      <div className="w-full bg-[#00205b] flex items-center justify-center py-20 -mt-1">
        <div className="mycontainer flex flex-col items-center justify-center gap-3">
          ...
          <div className="mt-10 gap-5 w-full flex flex-col md:flex-row justify-between">
            {/* --- Card 1 --- */}
            <div className="flex flex-col lg:flex-row gap-3 lg:w-1/3 w-full items-start">
              <div className="flex items-center justify-center rounded-full bg-[#1a376c] p-5">
            ...
            <div className="flex flex-col lg:flex-row gap-3 lg:w-1/3 w-full items-start">
              ...
              <div className="flex flex-col gap-3">
                ...
                <p className="lg:text-lg text-sm text-white">
                  We prioritize your needs and ensure you are completely
